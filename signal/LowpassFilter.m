function [x,f] = LowpassFilter(x,fs,fC,varargin)
% LowpassFilter
% 
% Description:	lowpass filter a signal
% 
% Syntax:	x = LowpassFilter(x,fs,fC,<options>)
% 
% In:
...
status('Lowpass filtering','silent',opt.silent);

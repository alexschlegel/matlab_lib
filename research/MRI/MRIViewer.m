...
function MRIViewer_OpeningFcn(hObject, eventdata, handles, varargin)
	...
	[strAnat,opt]		= ParseArgsOpt(varargin,FSLPathMNIAnatomical(),...
							'stat'				, ''				, ...
							'stat_min'			, []				, ...
							'stat_max'			, []				, ...
							'stat_palette'		, palDef			, ...
...
%	pK	- 1xN array of points
	[p,p1,p2,p3,opt]	= ParseArgsOpt(varargin,[],[],[],[],...
							'data'	, 'anat'	  ...
							);
...
function handles = SaveImage(handles,varargin)
	[strPathOut,opt]	= ParseArgsOpt(varargin,[],...
							'type'	, 'all'	  ...
							);

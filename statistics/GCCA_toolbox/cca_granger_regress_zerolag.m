function [ret] = cca_granger_regress_zerolag(X,nlags,STATFLAG)
% -----------------------------------------------------------------------
%   FUNCTION: cca_granger_regress_zerolag.m
%   PURPOSE:  perform multivariate regression with granger causality statistics
%             additionally include lag-zero in MVAR model
%
...
%   Updated AKS Nov 2010, implement zero-lag modification TODO
%   Ref: Seth, A.K. (2010) J Neuro Meth
% -----------------------------------------------------------------------

function [err,t,kState] = WaitDownOnce(inp,strButton,varargin)
% PTB.Device.Input.WaitDownOnce
% 
% Description:	wait until a button is down once (see PTB.Device.Input.DownOnce)
% 
% Syntax:	[err,t,kState] = inp.WaitDownOnce(strButton,[bLog]=true,<options>)
% 
% In:
...
% License.
[bLog,opt]	= ParseArgsOpt(varargin,true,...

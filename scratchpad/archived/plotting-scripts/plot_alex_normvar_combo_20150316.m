...
pd{2,1}		= plot_data;
load('scratchpad/capsules/20150316_204320_iflow_plot_data.mat');
pd{1,2}		= plot_data;
load('scratchpad/capsules/20150316_231712_iflow_plot_data.mat');
pd{2,2}		= plot_data;
...
%figfilename	= ['20150316_alex_normvar_combo_plotted_' FormatTime(nowms,'yyyymmdd_HHMM') '.fig'];
figfilename	= ['20150316_alex_normvar_combo.fig'];

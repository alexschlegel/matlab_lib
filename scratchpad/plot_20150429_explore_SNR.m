...
function hF = plot_20150429_explore_SNR
...
hF				= plot_quads_nTBlock_SNR(hF,cCapsule{1},vertVar,fixedPairs);
...
figfilepath		= sprintf('scratchpad/figfiles/%s-%s.fig',stem, ...
					FormatTime(nowms,'mmdd'));
savefig(hF(end:-1:1),figfilepath);
fprintf('Plots saved to %s\n',figfilepath);

end

function hF = plot_quads_nTBlock_SNR(hF,capsule,vertVar,fixedPairs)
	p			= Pipeline;
